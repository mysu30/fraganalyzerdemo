...
$e._inside = /(?:\[[^\]]*\]|\\[\[\]]|[^\[\]]|\](?=[^\[]*\]))*/, $e._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, $e.link = Ae($e.link)("inside", $e._inside)("href", $e._href)(), $e.reflink = Ae($e.reflink)("inside", $e._inside)(), $e.normal = Ue({}, $e), $e.pedantic = Ue({}, $e.normal, {
    ...
    return t ? '<pre><code class="' + this.options.langPrefix + Pe(t, !0) + '">' + (n ? e : Pe(e, !0)) + "\n</code></pre>\n" : "<pre><code>" + (n ? e : Pe(e, !0)) + "\n</code></pre>"
...
const Ie = "https://cdn.jsdelivr.net/npm/@observablehq/highlight.js@2.0.0/";
